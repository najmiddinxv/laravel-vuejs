    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{{route('admin.permission.index')}}">Index Role</a></li>
                ...
                <tr>
                 ...
                 <tr>
                  <td>
                     ...
                     <a href="{{route('admin.permission.index')}}" class="btn btn-success" title="cancel">
                          cancel
                      </a>
                    ...
                    <a href="{{route('admin.permission.destroy',$model->id)}}" class="delete-data-item btn btn-danger" title="delete">
                        delete
                    </a>
                    </div>
                  </td>
