                                ...
                                <div class="tab-pane fade active show" id="pills-uz" role="tabpanel" aria-labelledby="uz-tab">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title[uz]" id="title_uz"
                                            ...
                                            value="{{ $page->getTranslation('title', 'uz'), old('title.uz') }}" required>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <textarea class="form-control @error('description.uz') error-data-input @enderror" name="description[uz]" id="description_uz"  style="height: 130px;" >{{ $page->hasTranslation('description', 'uz') ? $page->getTranslation('description', 'uz') : '', old('description.uz') }}</textarea>
                                        <span class="error-data">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <textarea class="tinymce-editor @error('body.uz') error-data-input @enderror" name="body[uz]" id="body_uz"  style="height: 130px;" >{{ $page->hasTranslation('body', 'uz') ? $page->getTranslation('body', 'uz') : '', old('body.uz') }}</textarea>
                                        <span class="error-data">
                                            @error('body.uz')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div class="tab-pane fade" id="pills-ru" role="tabpanel" aria-labelledby="ru-tab">
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" name="title[ru]" id="title_ru"
                                            ...
                                            value="{{ $page->hasTranslation('title', 'ru') ? $page->getTranslation('title', 'ru') : '', old('title.ru') }}">
                                        <span class="error-data">
                                            @error('title.ru')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <textarea class="form-control @error('description.uz') error-data-input @enderror" name="description[ru]" id="description_ru" style="height: 130px;" >{{ $page->hasTranslation('description', 'ru') ? $page->getTranslation('description', 'ru') : '', old('description.ru') }}</textarea>
                                        <span class="error-data">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <textarea class="tinymce-editor @error('body.ru') error-data-input @enderror" name="body[ru]" id="body_ru"  style="height: 130px;" >{{ $page->hasTranslation('body', 'ru') ? $page->getTranslation('body', 'ru') : '', old('body.ru') }}</textarea>
                                        <span class="error-data">
                                            @error('body.ru')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div class="tab-pane fade" id="pills-en" role="tabpanel" aria-labelledby="en-tab">
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" name="title[en]" id="name_en"
                                            ...
                                            value="{{ $page->hasTranslation('title', 'en') ? $page->getTranslation('title', 'en') : '', old('title.en') }}">
                                        <span class="error-data">
                                            @error('title.en')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <textarea class="form-control @error('description.uz') error-data-input @enderror" name="description[en]" id="description_en" style="height: 130px;" >{{ $page->hasTranslation('description', 'en') ? $page->getTranslation('description', 'en') : '', old('description.en') }}</textarea>
                                        <span class="error-data">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <textarea class="tinymce-editor @error('body.en') error-data-input @enderror" name="body[en]" id="body_en"  style="height: 130px;" >{{ $page->hasTranslation('body', 'en') ? $page->getTranslation('body', 'en') : '', old('body.en') }}</textarea>
                                        <span class="error-data">
                                            @error('body.en')
                                                {{ $message }}
                                            @enderror
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mt-1">
                            ...
                            <select class="form-select" aria-label="Default select example" name="category_id" id="category_id">
                                @foreach ($categories as $category_item)
                                    <option value="{{ $category_item->id }}" {{ $category_item->id == $page->category?->id ? 'selected' : '' }}>{{ $category_item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select class="form-select" aria-label="Default select example" name="status" id="status">
                                ...
                                <option value="0" {{ $page->status == 0 ? 'selected' : '' }}>no active</option>
                            </select>
                        </div>
                        <div class="form-group mt-3">
                            ...
                            <select class="form-select" aria-label="Default select example" name="slider" id="slider">
                                <option value="1" {{ $page->slider == 1 ? 'selected' : '' }}>active</option>
                                <option value="0" {{ $page->slider == 0 ? 'selected' : '' }}>no active</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <img id="previewImage" src="{{ Storage::url($page->main_image['large'] ?? '-') }}" alt="Img" style="max-width: 100%;">
