                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="create-data" style="float: right;">
                            {{-- @role('super admin') --}}
                                <a href="{{route('model-has-role.create')}}" class=" style-add btn btn-primary">{{__('msg.Create')}}</a>
                            {{-- @else --}}
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="text-align: center;">
                                ...
                                <a href="{{route('model-has-role.edit',['role_id'=>$model->role_id,'model_id'=>$model->model_id])}}" class="btn btn-primary" title="update">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                               
                                <form style="display: inline-block;" action="{{route('model-has-role.destroy',['role_id'=>$model->role_id,'model_id'=>$model->model_id])}}" method="POST">
                                    @csrf
                                    @method('DELETE')
