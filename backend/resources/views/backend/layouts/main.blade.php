...
<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                        ...
                        <span
                            class="d-none d-md-block dropdown-toggle ps-2">{{ auth()->user()->email ?? 'user' }}</span>
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs(['backend.tags.*', 'backend.words.*', 'backend.categories.*', 'backend.menu.*', 'backend.tinymceFiles.*', 'backend.images.*']) ? '' : 'collapsed' }}"
                    data-bs-target="#content-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Content</span>
                    <i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="content-nav"
                    class="nav-content {{ request()->routeIs(['backend.tags.*', 'backend.words.*', 'backend.categories.*', 'backend.menu.*', 'backend.tinymceFiles.*', 'backend.images.*']) ? 'show' : 'collapse' }}  "
                    ...
                    <li>
                        <a href="{{ route('backend.menu.index') }}"
                            class="{{ request()->routeIs('backend.menu.*') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('backend.images.index') }}" class="{{ request()->routeIs('backend.images.*') ? 'active' : '' }}">
                            <i class="bi bi-circle"></i><span>Images</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('backend.tinymceFiles.index') }}" class="{{ request()->routeIs('backend.tinymceFiles.*') ? 'active' : '' }}">
                            <i class="bi bi-circle"></i><span>Files</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('backend.tags.index') }}"
                            class="{{ request()->routeIs('backend.tags.*') ? 'active' : '' }}">
                            <i class="bi bi-circle"></i><span>Tags</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('backend.words.index') }}"
                            class="{{ request()->routeIs('backend.words.*') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs(['backend.users.*', 'backend.roles.*', 'backend.permissions.*']) ? '' : 'collapsed' }}"
                    data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                    <i class="ri-settings-3-line"></i><span>Settings</span>
                    <i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-nav"
                    class="nav-content {{ request()->routeIs(['backend.users.*', 'backend.roles.*', 'backend.permissions.*']) ? 'show' : 'collapse' }}  "
                    data-bs-parent="#sidebar-nav">
                    <li>
                    ...
                    <li>
                        <a href="{{ route('backend.roles.index') }}"
                            class="{{ request()->routeIs('backend.roles.*') ? 'active' : '' }}">
                            <i class="bi bi-circle"></i><span>Roles</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('backend.permissions.index') }}"
                            class="{{ request()->routeIs('backend.permissions.*') ? 'active' : '' }}">
